...
$id = $_GET['catID'];
?>
<!-- Mirrored from themesground.com/alturas/V2/grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Aug 2020 05:33:27 GMT -->
          ...
          <article class="col-main">
            <div class="toolbar">
              <div class="display-product-option">
                <div class="sorter">
                  <div class="view-mode"> <span title="Grid" class="button button-active button-grid">&nbsp;</span><a href="list.php?catID=<?php echo $id ?>" title="List" class="button-list">&nbsp;</a> </div>
                </div>
                <div class="pages">
                  <label>Page:</label>
                  <ul class="pagination">
              ...
              <div class="new-arrivals-block inner-page">
                ...
                <div id="new-arrivals-slider" class="product-flexslider hidden-buttons">
                  ...
                  <div class="slider-items slider-width-col4 products-grid block-content">
                    <div class="item">
                      <div class="cat-img"><img alt="Mens" src="images/custom-img1.jpg"></div>
                      <div class="categories-list">
                     <strong> Veg Salads</strong>
                      <ul>
                    ...
                    <!-- Item -->
                    <div class="item">
                      <div class="cat-img"><img alt="Mens" src="images/custom-img2.jpg"></div>
                      <div class="categories-list">
                     <strong> Dressings Salads</strong>
                      <ul>
                    ...
                    <!-- Item -->
                    <div class="item">
                      <div class="cat-img"><img alt="Mens" src="images/custom-img3.jpg"></div>
                      <div class="categories-list">
                     <strong>Fruits Salads</strong>
                      <ul>
                    ...
                    <!-- End Item -->
                    <div class="item">
                      <div class="cat-img"><img alt="Mens" src="images/custom-img4.jpg"></div>
                      <div class="categories-list">
                     <strong>Bagged Salads</strong>
                      <ul>
...
<!-- Mirrored from themesground.com/alturas/V2/grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Aug 2020 05:33:43 GMT -->
</html>
