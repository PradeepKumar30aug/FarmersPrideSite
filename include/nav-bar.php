      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 pull-left">
            <div class="dropdown block-language-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#"> <img src="images/flag.png" alt="language"> INDIA <span class=""></span> </a>
            ...
            <!-- End Header Language --> 
            <!-- Header Currency -->
            <div class="dropdown block-currency-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-currency dropdown-toggle" href="#"> INR <span class=""></span></a>
              <ul class="dropdown-menu" role="menu">
            ...
            <!-- End Header Currency -->
            <div class="welcome-msg"> Choosing Organic Product </div>
          </div>
          <!-- Header Top Links -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 logo-block" style="text-align: center;"> 
          <!-- Header Logo -->
          <div class="logo"> <a title="alturas" href="index.php"><img alt="alturas" src="images/logo.png"> </a> </div>
          <!-- End Header Logo --> 
        </div>
        <div class="col-lg-7 col-md-6 col-sm-9 col-xs-12 category-search-form">
        <div class="contact-row" style="text-align: center;">
                            <div class="phone inline">
                                <i class="fa fa-phone"></i> (+91) 7987551332
                            </div>
                            <div class="contact inline">
                                <i class="fa fa-envelope"></i> farmerspride27@<span class="le-color">gmail.com</span>
                            </div>
                        </div>
              ...
              <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle"  data-toggle="dropdown" href="category.html">Categories <b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu" >
                      ...
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Salas</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Juice</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Meats</a></li>
                    </ul>
                  </li>
                </ul>
        ...
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12 card_wishlist_area">
          ...
          <div class="top-cart-contain"> 
            <!-- Top Cart -->
            <div class="mini-cart">
              <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle"> <a href="shopping_cart.html"><span class="cart-label">Shopping Cart</span> <span class="cart_count">0</span>
              ...
              <div>
                <!-- <div class="top-cart-content">  -->
                 ...
                 <!--  <ul class="mini-products-list" id="cart-sidebar">
                    <li class="item first">
                      <div class="item-inner"> <a class="product-image" title="Retis lapen casen" href="#l"><img alt="Retis lapen casen" src="products-images/product6.jpg"> </a>
